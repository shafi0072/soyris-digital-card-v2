export const field_data = [
  {
    ...
    fields: [
      {
        name: 'Phone',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="26.832" height="30" viewBox="0 0 26.832 30">
      ...
      {
        name: 'Email',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="32.5" height="32.5" viewBox="0 0 32.5 32.5">
          <path id="email-svgrepo-com" d="M24.667,18A6.667,6.667,0,1,1,18,11.333,6.667,6.667,0,0,1,24.667,18Zm0,0v2.5a4.167,4.167,0,0,0,4.167,4.167h0A4.167,4.167,0,0,0,33,20.5V18A15,15,0,1,0,18,33h6.667" transform="translate(-1.75 -1.75)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2.5" />
        </svg>

      },
      {
        name: 'Address',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24.008" height="32.063" viewBox="0 0 24.008 32.063">
          <g id="layer1" transform="translate(-0.322 -287.797)">
            <path id="path929" d="M12.322,288.8a11.015,11.015,0,0,0-11,11c0,10.67,10.38,18.781,10.38,18.781a1,1,0,0,0,1.248,0s10.38-8.112,10.38-18.781A11.021,11.021,0,0,0,12.322,288.8Zm0,2a8.99,8.99,0,0,1,9.007,9c0,8.729-7.9,15.625-9,16.559-1.09-.929-9.007-7.827-9.007-16.559A8.983,8.983,0,0,1,12.322,290.8Z" transform="translate(0)" stroke="#000" strokeWidth="2" />
            <path id="circle931" d="M4.232,290.385a1.323,1.323,0,1,0,1.324,1.322A1.326,1.326,0,0,0,4.232,290.385Zm0,.529a.794.794,0,1,1-.793.793A.79.79,0,0,1,4.232,290.914Z" transform="translate(8.093 6.622)" stroke="#000" strokeWidth="2" />
          </g>
        </svg>
  ...
  },
  {
    ...
    fields: [
      {
        name: 'WhatsApp',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30.708" height="30.894" viewBox="0 0 30.708 30.894">
          <g id="Group_11" data-name="Group 11" transform="translate(-1314.304 -532.5)">
            <g id="whatsapp-svgrepo-com" transform="translate(1314.41 532.5)">
              <path id="Path_14" data-name="Path 14" d="M18.447,14.412c-.376-.178-2.178-1.069-2.515-1.208s-.574-.178-.832.2-.95,1.188-1.168,1.445-.416.277-.792,0a10.158,10.158,0,0,1-2.95-1.822,10.4,10.4,0,0,1-1.98-2.554c-.218-.356,0-.554.158-.752s.356-.416.554-.634a2.752,2.752,0,0,0,.356-.614.752.752,0,0,0,0-.653c0-.178-.832-1.98-1.148-2.713s-.594-.634-.812-.634H6.527a1.426,1.426,0,0,0-.99.455A4.158,4.158,0,0,0,4.25,8a7.108,7.108,0,0,0,1.485,3.861A16.474,16.474,0,0,0,12.052,17.4c.871.376,1.544.594,2.079.772a5.009,5.009,0,0,0,2.317.139,3.821,3.821,0,0,0,2.495-1.742,3.307,3.307,0,0,0,.218-1.742A2.055,2.055,0,0,0,18.447,14.412Z" transform="translate(3.587 3.889)" stroke="#707070" strokeWidth="1" />
              <path id="Path_15" data-name="Path 15" d="M25.736,4.817A14.573,14.573,0,0,0,15.262.5,14.731,14.731,0,0,0,2.57,22.578L.59,30.2l7.8-1.98A14.652,14.652,0,0,0,15.42,30h-.158A14.731,14.731,0,0,0,25.736,4.817ZM15.262,27.468a12.118,12.118,0,0,1-6.237-1.723l-.436-.257L3.956,26.7l1.228-4.514-.277-.455a12.227,12.227,0,1,1,10.356,5.742Z" transform="translate(0 0)" stroke="#707070" strokeWidth="1" />
            </g>
          </g>
        </svg>
      ...
      {
        name: 'Viber',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="29.668" height="30.585" viewBox="0 0 29.668 30.585">
          <g id="viber-svgrepo-com" transform="translate(-0.666 -0.56)">
            ...
            <path id="Path_19" data-name="Path 19" d="M9.633,31.017q.056.031.115.056c.71.305,1.587-.377,3.341-1.74l1.757-1.367A24.9,24.9,0,0,0,23.761,26.8a9.162,9.162,0,0,0,5.621-5.621,25.868,25.868,0,0,0,0-13.9A9.162,9.162,0,0,0,23.761,1.65C19.571.184,11.351.211,7.239,1.65A9.162,9.162,0,0,0,1.617,7.271a25.868,25.868,0,0,0,0,13.9A9.162,9.162,0,0,0,7.239,26.8a14.469,14.469,0,0,0,1.717.514C8.956,29.533,8.956,30.644,9.633,31.017Zm1.94-3.822V25.729a.652.652,0,0,0-.516-.638A24.149,24.149,0,0,1,8.1,24.326a6.544,6.544,0,0,1-4.015-4.015,19.986,19.986,0,0,1-.8-6.088,19.986,19.986,0,0,1,.8-6.088A6.544,6.544,0,0,1,8.1,4.12a24.707,24.707,0,0,1,7.37-.943A24.642,24.642,0,0,1,22.9,4.12a6.544,6.544,0,0,1,4.015,4.015,19.985,19.985,0,0,1,.8,6.088,19.985,19.985,0,0,1-.8,6.088A6.544,6.544,0,0,1,22.9,24.326a23.92,23.92,0,0,1-8.674,1,.658.658,0,0,0-.423.138Z" transform="translate(0 0)" fill="#0f0f0f" fillRule="evenodd" />
          </g>
        </svg>
  ...
  },
  {
    ...
    fields: [
      {
        name: 'Facebook',
        icon: <svg id="Page-1" xmlns="http://www.w3.org/2000/svg" width="15" height="30" viewBox="0 0 15 30">
          <g id="Dribbble-Light-Preview">
            <g id="icons">
              <path id="facebook-_176_" data-name="facebook-[#176]" d="M339.232,7269v-13.5h4.1l.669-6h-4.768v-2.922c0-1.544.039-3.078,2.2-3.078h2.187v-4.29a24.2,24.2,0,0,0-3.779-.21c-3.968,0-6.453,2.486-6.453,7.05v3.45H329v6h4.385V7269Z" transform="translate(-329 -7239)" fillRule="evenodd" />
            </g>
          </g>
        </svg>
      ...
      },
      {
        ...
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="32.5" height="32.5" viewBox="0 0 32.5 32.5">
          <g id="instagram-svgrepo-com" transform="translate(-4.25 -3.75)">
            <path id="Path_10" data-name="Path 10" d="M26.929,5H14.071A8.571,8.571,0,0,0,5.5,13.571V26.429A8.571,8.571,0,0,0,14.071,35H26.929A8.572,8.572,0,0,0,35.5,26.429V13.571A8.571,8.571,0,0,0,26.929,5Z" transform="translate(0)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2.5" fillRule="evenodd" />
            <path id="Path_11" data-name="Path 11" d="M14.964,19.929a5.464,5.464,0,1,1,3.864-1.6A5.464,5.464,0,0,1,14.964,19.929Z" transform="translate(5.536 5.536)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2.5" fillRule="evenodd" />
            <rect id="Rectangle_38" data-name="Rectangle 38" width="3" height="3" rx="1" transform="translate(27.7 12.8) rotate(-90)" />
            <rect id="Rectangle_39" data-name="Rectangle 39" width="1.821" height="1.821" rx="0.5" transform="translate(28.26 12.24) rotate(-90)" fill="none" stroke="#000" stroke-linecap="round" strokeWidth="2.5" />
          </g>
        </svg>
      ...
      {
        name: 'Twitter',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="36.71" height="30" viewBox="0 0 36.71 30">
  ...
  },
  {
    ...
    fields: [
      {
        name: 'Image',
        icon: <svg id="image-svgrepo-com" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
          <rect id="Rectangle_84" data-name="Rectangle 84" width="30" height="30" fill="none" />
          <path id="Path_25" data-name="Path 25" d="M27,20.333v5.333A1.333,1.333,0,0,1,25.667,27H4.333A1.333,1.333,0,0,1,3,25.667V23m24-2.667v-16A1.333,1.333,0,0,0,25.667,3H4.333A1.333,1.333,0,0,0,3,4.333V23m24-2.667-7.356-4.9a1.333,1.333,0,0,0-1.336-.083L3,23" fill="none" stroke="#000" stroke-linejoin="round" strokeWidth="1.5" />
          <circle id="Ellipse_18" data-name="Ellipse 18" cx="2" cy="2" r="2" transform="translate(7.8 9.1)" fill="none" stroke="#000" stroke-linejoin="round" strokeWidth="1.5" />
        </svg>

      },
      {
        name: 'Gallery',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="31.774" height="29.156" viewBox="0 0 31.774 29.156">
          <g id="gallery-wide-svgrepo-com" transform="translate(-0.976 -2.25)">
            <path id="Path_26" data-name="Path 26" d="M32,18.047c0,5.944,0,8.916-1.757,10.763S25.657,30.656,20,30.656H14c-5.657,0-8.485,0-10.243-1.847S2,23.991,2,18.047,2,9.131,3.757,7.284,8.343,5.438,14,5.438h6c5.657,0,8.485,0,10.243,1.847,1,1.046,1.427,2.453,1.614,4.557" fill="none" stroke="#000" stroke-linecap="round" strokeWidth="1.5" />
            <path id="Path_27" data-name="Path 27" d="M3.988,6A2.833,2.833,0,0,1,5.353,3.937C6.887,3,9.356,3,14.294,3h5.237c4.938,0,7.407,0,8.941.937A2.833,2.833,0,0,1,29.837,6" transform="translate(0)" fill="none" stroke="#000" strokeWidth="1.5" />
            <circle id="Ellipse_19" data-name="Ellipse 19" cx="1.5" cy="1.5" r="1.5" transform="translate(24.235 11.685)" fill="none" stroke="#000" strokeWidth="1.5" />
            <path id="Path_28" data-name="Path 28" d="M2,13.938,4.673,12.4a4.941,4.941,0,0,1,4.794.1l6.547,4.29a4.32,4.32,0,0,0,3.914.222l.455-.21a6.535,6.535,0,0,1,5.7.225l4.92,2.9" transform="translate(0 9.219)" fill="none" stroke="#000" stroke-linecap="round" strokeWidth="1.5" />
          </g>
        </svg>
  ...
  },
  {
    ...
    fields: [
      {
        name: 'Youtube',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32.421 28">
      ...
      {
        name: 'Vimeo',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 33 28.811">
      ...
      {
        name: 'Wistia',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="23.347" viewBox="0 0 30 23.347">
  ...
  },
  {
    ...
    fields: [
      {
        name: 'PDF',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 27.248 33.489">
          <g id="pdf-svgrepo-com" transform="translate(-47.706)">
            <path id="Path_29" data-name="Path 29" d="M69.337,0H57.348l-.609.609L48.315,9.033l-.609.609V27.871a5.625,5.625,0,0,0,5.618,5.618H69.337a5.624,5.624,0,0,0,5.617-5.618V5.618A5.624,5.624,0,0,0,69.337,0Zm3.538,27.871a3.538,3.538,0,0,1-3.538,3.538H53.324a3.538,3.538,0,0,1-3.538-3.538V10.5h5.476A2.949,2.949,0,0,0,58.21,7.556V2.08H69.337a3.538,3.538,0,0,1,3.538,3.538Z" />
            <path id="Path_30" data-name="Path 30" d="M137.166,252.785H135.3a.534.534,0,0,0-.568.577v4.824a.654.654,0,1,0,1.305,0v-1.466a.048.048,0,0,1,.054-.053h1.075a1.948,1.948,0,1,0,0-3.882Zm-.08,2.754h-.995a.047.047,0,0,1-.054-.053v-1.519a.047.047,0,0,1,.054-.053h.995a.815.815,0,1,1,0,1.626Z" transform="translate(-81.334 -236.251)" />
            <path id="Path_31" data-name="Path 31" d="M221.635,252.785h-1.43a.534.534,0,0,0-.568.577v4.9a.527.527,0,0,0,.568.569h1.43c1.288,0,2.088-.409,2.408-1.395a7.509,7.509,0,0,0,0-3.252C223.723,253.194,222.923,252.785,221.635,252.785Zm1.155,4.193c-.152.48-.586.684-1.191.684H221a.048.048,0,0,1-.054-.053V254a.048.048,0,0,1,.054-.053h.6c.6,0,1.039.2,1.191.684a6.543,6.543,0,0,1,0,2.346Z" transform="translate(-160.685 -236.251)" />
            <path id="Path_32" data-name="Path 32" d="M311.155,252.785h-2.931a.535.535,0,0,0-.569.577v4.824a.654.654,0,1,0,1.306,0v-1.724a.047.047,0,0,1,.053-.053h1.706a.561.561,0,1,0,0-1.119h-1.706a.047.047,0,0,1-.053-.053v-1.271a.047.047,0,0,1,.053-.053h2.141a.565.565,0,1,0,0-1.128Z" transform="translate(-242.946 -236.251)" />
          </g>
        </svg>
      ...
      {
        name: 'Notes',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 31.543 32.103">
      ...
      {
        name: 'Date',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 29.556 33">
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'URL',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30.841 30.841">
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'Header',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 30">
      ...
      {
        name: 'Divider',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 3">
          <path id="divider-horizontal-svgrepo-com" d="M2,7.5c0-.276.611-.5,1.364-.5H30.636C31.389,7,32,7.224,32,7.5s-.611.5-1.364.5H3.364C2.611,8,2,7.776,2,7.5Z" transform="translate(-1 -6)" stroke="#000" stroke-width="2" fill-rule="evenodd" />
        </svg>
      },
    ]
  },
