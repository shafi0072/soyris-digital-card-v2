  ...
  return (
    <div className="background">
      <div className="flex justify-center ">
        {!signUp && (
          <div className="container w-[30%] content-center  border shadow-lg bg-white rounded mt-[2%] p-5">
            ...
            <form onSubmit={handleSignIn} className="space-y-8 mb-5">
              ...
              <p className="text-sm text-center dark:text-gray-400">
                ...
                <button
                  ...
                  rel="noopener noreferrer"
                  className="focus:underline underline font-bold text-[#4285F4]"
                >
                  Sign up{" "}
                </button>
                here
        ...
        {signUp && (
          <div className="container w-[30%] content-center rounded bg-white mt-[2%] border shadow-lg  p-5  ">
            <div className=" content-center ">
              ...
              <div className="space-y-4">
                ...
                <div class="flex items-center mb-4">
                  ...
                  >
                    ...
                    <span className="text-blue-600">Acceptable Use Policy</span>{" "}
                  </label>
                </div>
                <div className="flex justify-center">
                  <button
