...
const Email = ({ index, handleEmailInputChange, items, from }) => {
      ...
      <div className="mb-3">
        <div className="w-full relative ">
          <input
            ...
            onChange={(e) =>
              handleEmailInputChange(index, `address`, e.target.value)
            }
            type="text"
          ...
          <label htmlFor="" className="absolute top-3 left-3">
            ...
            >
              <path
                ...
                d="M2.672,15.431H14.759a.672.672,0,0,0,.672-.672V2.672A.672.672,0,0,0,14.759,2H2.672A.672.672,0,0,0,2,2.672V14.759a.672.672,0,0,0,.672.672Zm.672-8.059H4.686v6.715H3.343Zm10.745,6.715H6.029V7.372h8.059ZM3.343,3.343H14.088V6.029H3.343Z"
      ...
      <div className="mb-3">
        <div className="w-full relative ">
          <input
            ...
            onChange={(e) =>
              handleEmailInputChange(index, `label`, e.target.value)
            }
            type="text"
            placeholder="Label"
            className="border w-full border-[#C1C1C1] rounded-xl ps-8 pr-1 py-1 "
