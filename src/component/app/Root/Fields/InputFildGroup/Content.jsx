        ...
        fetch(`${baseUrl}/add-user/profile/fields/${userData?._id}`, {
            ...
            body: JSON.stringify({
                fields: {
                    ...
                    email: [...userData?.fields?.email, ...emailData?.filter((items, index) => items !== undefined)],
                    address: [...userData?.fields?.address, ...addressData?.filter((items, index) => items !== undefined)],
                    link: [...userData?.fields?.link, ...linkData?.filter((items, index) => items !== undefined)],
                    whatsApp: [...userData?.fields?.whatsApp, ...whatsAppData?.filter((items, index) => items !== undefined)],
                    viber: [...userData?.fields?.viber, ...viberData?.filter((items, index) => items !== undefined)],
                    skype: [...userData?.fields?.skype, ...skypeData?.filter((items, index) => items !== undefined)],
                    snapChat: [...userData?.fields?.snapChat, ...snapChatData?.filter((items, index) => items !== undefined)],
                    signal: [...userData?.fields?.signal, ...signalData?.filter((items, index) => items !== undefined)],
                    telegram: [...userData?.fields?.telegram, ...telegramData?.filter((items, index) => items !== undefined)],
                    discord: [...userData?.fields?.discord, ...discordData?.filter((items, index) => items !== undefined)],
                    slack: [...userData?.fields?.slack, ...slackData?.filter((items, index) => items !== undefined)],
                    facebook: [...userData?.fields?.facebook, ...facebookData?.filter((items, index) => items !== undefined)],
                    instagram: [...userData?.fields?.instagram, ...instagramData?.filter((items, index) => items !== undefined)],
                    twitter: [...userData?.fields?.twitter, ...twitterData?.filter((items, index) => items !== undefined)],
                    linkedin: [...userData?.fields?.linkedin, ...linkedinData?.filter((items, index) => items !== undefined)],
                    pinterest: [...userData?.fields?.pinterest, ...pinterestData?.filter((items, index) => items !== undefined)],
                    tiktok: [...userData?.fields?.tiktok, ...tiktokData?.filter((items, index) => items !== undefined)],
                    youtube: [...userData?.fields?.youtube, ...youtubeData?.filter((items, index) => items !== undefined)],
                    vimeo: [...userData?.fields?.vimeo, ...vimeoData?.filter((items, index) => items !== undefined)],
                    wistia: [...userData?.fields?.wistia, ...wistiaData?.filter((items, index) => items !== undefined)],
                    note: [...userData?.fields?.note, ...noteData?.filter((items, index) => items !== undefined)],
                    date: [...userData?.fields?.date, ...dateData?.filter((items, index) => items !== undefined)],
                    qr: [...userData?.fields?.qr, ...qrData?.filter((items, index) => items !== undefined)],
                    Header: [...userData?.fields?.Header, ...headerData?.filter((items, index) => items !== undefined)],
                    divider: [...userData?.fields?.divider, ...dividerData?.filter((items, index) => items !== undefined)],
                }
            })
        })
    }
