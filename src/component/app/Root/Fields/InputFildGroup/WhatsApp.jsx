...
const WhatsApp = ({index,handleWhatsAppInputChange,items,from}) => {
          ...
          <CloseIcon />
            ...
            <div className='mb-3'>
                <div className='w-full relative '>
                    ...
                    type="text" placeholder='@michael21' className='border w-full border-[#C1C1C1] rounded-xl ps-8 pr-1 py-1 ' />
