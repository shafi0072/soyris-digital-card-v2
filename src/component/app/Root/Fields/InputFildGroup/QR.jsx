...
const QR = ({ index, handleQRInputChange, items, from,qrWidth,setQrWidth,qrAlign,setQrAlign }) => {
  console.log({items});
  console.log({qrAlign});
    ...
    <div className="bg-white px-4 py-2 rounded-lg">
      ...
      <div className="mt-3 flex items-center gap-4">
                  ...
                  <div className="flex border-4 border-[#D5D8DC] rounded-lg">
                    <button
                      className={`p-2 ${items?.alignment === "left" && "bg-[#D5D8DC]" || qrAlign  === "left" && "bg-[#D5D8DC]"}`}
                      onClick={() => setQrAlign("left")}
                    >
                      <svg
                    ...
                    <button
                      className={`p-2 ${items?.alignment === "center" && "bg-[#D5D8DC]" || qrAlign === "center" && "bg-[#D5D8DC]"}`}
                      onClick={() => setQrAlign("center")}
                    >
                      <svg
                    ...
                    <button
                      className={`p-2 ${items?.alignment  === "right" && "bg-[#D5D8DC]" || qrAlign === "right" && "bg-[#D5D8DC]"}`}
                      onClick={() => setQrAlign("right")}
                    >
                      <svg
