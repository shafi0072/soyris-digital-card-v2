...
const Link = ({ index, handleLinkInputChange, items, from }) => {
      ...
      <div className="mb-3">
        <div className="w-full relative ">
          <input
            ...
            onChange={(e) =>
              handleLinkInputChange(index, `url`, e.target.value)
            }
            type="text"
      ...
      <div className="mb-3">
        <div className="w-full relative ">
          <input
            ...
            onChange={(e) =>
              handleLinkInputChange(index, `name`, e.target.value)
            }
            type="text"
      ...
      <div className="mb-3">
        <div className="w-full relative ">
          <input
            name={`label`}
            onChange={(e) =>
              handleLinkInputChange(index, `label`, e.target.value)
            }
            type="text"
            placeholder="Label"
            className="border w-full border-[#C1C1C1] rounded-xl ps-8 pr-1 py-1 "
