...
const Twitter = ({ index, handleTwitterInputChange, items, from }) => {
      ...
      <div className="mb-3">
        <div className="w-full relative ">
          <input
            ...
            onChange={(e) =>
              handleTwitterInputChange(index, `url`, e.target.value)
            }
            type="text"
            placeholder="twitter.com/michael21"
