                ...
                <form >
                    ...
                    <div className='grid grid-cols-2 mb-5'>
                        <div className=''>
                            ...
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='first_name' id='first_name' />

                        </div>
                        <div className=''>
                            <label htmlFor="last_name" className='block mb-2'>Last Name</label>
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='last_name' id='last_name' />
                    ...
                    <div className='grid grid-cols-2 mb-5'>
                        <div className=''>
                            ...
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='prefix' id='prefix' />

                        </div>
                        <div className=''>
                            <label htmlFor="suffix" className='block mb-2'>Suffix</label>
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='suffix' id='suffix' />
                    ...
                    <div className='grid grid-cols-2 mb-5'>
                        <div className=''>
                            ...
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='accreditations' id='accreditations' />

                        </div>
                        <div className=''>
                            <label htmlFor="preferred_name" className='block mb-2'>Preferred Name</label>
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='preferred_name' id='preferred_name' />
                    ...
                    <div className='grid grid-cols-2 mb-5'>
                        <div className=''>
                            ...
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='job_title' id='job_title' />

                        </div>
                        <div className=''>
                            <label htmlFor="pronouns" className='block mb-2'>Pronouns</label>
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='pronouns' id='pronouns' />
                    ...
                    <div className='grid grid-cols-2 mb-5'>
                        <div className=''>
                            ...
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='department' id='department' />

                        </div>
                        <div className=''>
                            <label htmlFor="company" className='block mb-2'>Company</label>
                            <input type="text" className='w-[300px] py-1 shadow-md rounded px-2 border border-[#CBD5E0]' name='company' id='company' />
                    ...
                    <div className="mb-8">
                        ...
                        <textarea id="introduction" rows="5" class="block w-[636px] p-2.5  text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " ></textarea>
                    </div>
