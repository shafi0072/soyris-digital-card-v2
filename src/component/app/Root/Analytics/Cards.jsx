...
const Cards = () => {
  ...
  const totalViews = userCardData?.anylatics?.reduce((total, item) => {
    if (item.type === "view") {
      return total + item.view;
    }
    return total;
  }, 0);
  ...
  userCardData?.anylatics?.forEach((obj) => {
      ...
      <div className="flex gap-6 justify-between items-center bg-white shadow-lg rounded py-3 px-5 ">
        <div>
          ...
          <p>
            ...
            <span
              className={
                cardViews === "increase" ? "text-[#0A7C57]" : "text-[#DB112D]"
              }
            >
              +3.48 %
            </span>{" "}
      ...
      <div className="flex gap-6 justify-between items-center bg-white shadow-lg rounded py-3 px-5 ">
        <div>
          ...
          <p>
            ...
            <span
              className={
                uniqueUsers === "increase" ? "text-[#0A7C57]" : "text-[#DB112D]"
              }
            >
              -1.28%
            </span>{" "}
