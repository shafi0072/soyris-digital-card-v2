...
const Favicon = () => {
  ...
  const { favicon,
    setFavicon } = useContext(userContext);
    ...
    <div className="mb-[100px]">
      <div className='mt-8 flex items-center justify-between w-3/4'>
        ...
        <div className="w-[266px]">
          <label htmlFor='favicons' className='cursor-pointer flex bg-gray-200 px-3 py-1 rounded-full' style={{ marginLeft: favicon ? '10%' : 0 }}>
            <AddIcon sx={{ color: '#0053a2' }} />
            <p className="text-md">{favicon ? 'Replace Favicon' : 'Add Favicon'}</p>
          </label>
          <input
            type="file"
            id="favicons"
