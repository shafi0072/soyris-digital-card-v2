...
const Classic = ({color, profileImage,logoImage}) => {
  return (
   <div className="mx-4">
     <div className='bg-white w-[100%]   relative rounded' style={{background:color}}>
                    {profileImage && <img className='h-full w-[100%] object-cover rounded' src={profileImage ? profileImage : ""} alt="" />}
                    <div className=''>
                        ...
                        <div className='absolute -bottom-[6px] -right-2 z-[5]'>
