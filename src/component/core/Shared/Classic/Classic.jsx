        ...
        <div className="mx-4">
            ...
            <div className='bg-white w-[100%] relative rounded' >
                ...
                <div className='relative'>
                    ...
                    {profileImage ?<img className='h-full w-[100%] object-cover rounded-2xl' src={profileImage ? profileImage : ""} alt="" />: <div className='w-[100%]  h-[331px]'  style={{background:'#fff'}}></div>}
