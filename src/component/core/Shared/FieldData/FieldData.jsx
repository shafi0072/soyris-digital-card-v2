...
const FieldData = ({ userData, newFeilds }) => {
  ...
  return (
    <div>
      ...
      {userData?.fields?.skype?.map((items, index) => (
        <Data1
          color={color}
          icon={skypeIcon}
          title={items.number}
      ...
      {newFeilds?.fields?.skype?.map((items, index) => (
        <Data1
          color={color}
          icon={skypeIcon}
          title={items.number}
      ...
      {userData?.fields?.snapchat?.map((items, index) => (
        <Data1
          color={color}
          icon={snapchatIcon}
          title={items.number}
      ...
      {newFeilds?.fields?.snapchat?.map((items, index) => (
        <Data1
          color={color}
          icon={snapchatIcon}
          title={items.number}
      ...
      {userData?.fields?.signal?.map((items, index) => (
        <Data1
          color={color}
          icon={signalIcon}
          title={items.number}
      ...
      {newFeilds?.fields?.signal?.map((items, index) => (
        <Data1
          color={color}
          icon={signalIcon}
          title={items.number}
      ...
      {userData?.fields?.telegram?.map((items, index) => (
        <Data1
          color={color}
          icon={telegramIcon}
          title={items.number}
      ...
      {newFeilds?.fields?.telegram?.map((items, index) => (
        <Data1
          color={color}
          icon={telegramIcon}
          title={items.number}
      ...
      {userData?.fields?.discord?.map((items, index) => (
        <Data1
          color={color}
          icon={discordIcon}
          title={items.number}
      ...
      {newFeilds?.fields?.discord?.map((items, index) => (
        <Data1
          color={color}
          icon={discordIcon}
          title={items.number}
      ...
      {userData?.fields?.slack?.map((items, index) => (
        <Data1
          color={color}
          icon={slackIcon}
          title={items.number}
      ...
      {newFeilds?.fields?.slack?.map((items, index) => (
        <Data1
          color={color}
          icon={slackIcon}
          title={items.number}
